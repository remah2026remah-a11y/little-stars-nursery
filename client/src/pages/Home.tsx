...
const gallery = [
  { src: `${import.meta.env.BASE_URL}activity-art.jpg`, title: "ألواننا الأولى", category: "نشاطات فنية", tone: "yellow" },
  { src: `${import.meta.env.BASE_URL}activity-garden.jpg`, title: "مستكشفو الحديقة", category: "وقت الطبيعة", tone: "teal" },
  { src: `${import.meta.env.BASE_URL}activity-music.jpg`, title: "نغني معاً", category: "موسيقى وحركة", tone: "coral" },
];
const meals = [
  ...
  return (
    <main dir="rtl" className="site-shell">
      ...
      <header className="nav-wrap">
        ...
        <div className="nav-actions"><a href="tel:+962772520111" className="phone"><Phone size={16} /> ٠٧٧٢ ٥٢٠ ١١١</a><button className="primary-btn nav-cta" onClick={reserve}>احجزوا عبر واتساب <MessageCircle size={17} /></button></div>
      ...
      <section id="home" className="hero">
        ...
        <div className="hero-visual"><div className="image-frame"><img src={`${import.meta.env.BASE_URL}nursery-hero.jpg`} alt="أطفال يلعبون في حضانة نجوم صغيرة" /><div className="image-badge"><span className="live-dot" /> <b>يومنا مليء بالمرح</b><small>نلعب • نتعلم • نكبر</small></div></div><div className="scribble one">✦</div><div className="scribble two">☼</div><div className="floating-card"><div className="heart-icon">♥</div><div><b>رعاية بقلب كبير</b><small>فريقنا معتمد ومحب</small></div></div></div>
      ...
      <footer><div className="brand"><div className="brand-mark"><span>✦</span></div><div><strong>نجوم صغيرة</strong><small>حضانة ورعاية مبكرة</small></div></div><span>نزرع اليوم، ليزهروا غداً © 2024</span><div className="footer-links"><a href="tel:+962772520111">اتصلوا بنا</a><a href="#home">الخصوصية</a><a href="/parents">بوابة الأهل</a></div></footer>
